    ...
    <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      <Card>
        <div className="px-4 py-5 sm:px-6">
          <h2 className="text-2xl font-semibold text-gray-900">About FeedBackly</h2>
        ...
        <CardContent className="border-t border-gray-200 px-4 py-5 sm:px-6">
          <div className="prose max-w-none">
            <p>FeedBackly is a comprehensive survey management application built with the MERN stack (MongoDB, Express, React, Node.js). Our platform allows organizations to collect, manage, and analyze survey data efficiently.</p>
            ...
            <p>We've built FeedBackly using modern web technologies:</p>
            <ul className="list-disc pl-5 space-y-2">
